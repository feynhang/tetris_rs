...
pub(crate) const NEXTS_INIT_POINT: Point = Point::new_const(2, 23);
pub(crate) const HOLD_INIT_POINT: Point = Point::new_const(2, 2);

pub(crate) const HOLD_TETRO_CENTER: Point = Point::new_const(1, 3);
pub(crate) const TETRIS_PIECE_INIT_POINT: Point = Point::new_const(20, 4);
pub(crate) const GAMEOVER_POINT: Point = Point::new_with_b2c(10, 13);
